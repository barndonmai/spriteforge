...
from app.services.providers.prompt_templates import (
    build_character_summary_prompt,
    build_classification_prompt,
    build_object_generation_prompt,
    build_object_summary_prompt,
)
...
class GeminiImageProvider(ImageProvider):
    ...
    def _build_classification_prompt(self, notes: str | None) -> str:
        return build_classification_prompt(notes)

    def _build_character_summary_prompt(self, notes: str | None) -> str:
        return build_character_summary_prompt(notes)

    def _build_object_summary_prompt(self, notes: str | None) -> str:
        return build_object_summary_prompt(notes)
    ...
    def _build_object_generation_prompt(self, summary: dict[str, Any]) -> str:
        return build_object_generation_prompt(summary)
